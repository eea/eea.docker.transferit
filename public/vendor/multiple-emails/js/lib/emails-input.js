...
lib.EmailsInput = (function(utils) {
  ...
  function init(inputContainerNode, options) {
    inputContainerNode.innerHTML = ' \
      <div class="d-flex flex-wrap emails emails-input form-control form-control-lg"> \
  ...
  function buildOptions(givenOptions) {
    ...
    options.placeholder = options.placeholder || 'add email address ...'
  ...
  function addChip(refElement, email) {
    ...
    chip.innerHTML = '<span id="content" class="content">'
